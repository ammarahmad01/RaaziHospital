  ...
  return (
    <section id="services" className="relative bg-surface-dim py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            ...
            <div className="relative w-full md:w-72">
              ...
              <input
                ...
                className="w-full rounded-xl border border-neutral-200 bg-white py-2.5 pl-10 pr-9 text-xs font-medium text-neutral placeholder:text-neutral-400 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary md:text-sm"
              />
              {searchQuery && (
                <button
        ...
        {/* ── All Services Grid with Relevant Photography ── */}
